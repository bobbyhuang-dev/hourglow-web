(function () {
  ...
  var STRINGS = {
    en: {
      ...
      installCompatibility: "One download for Apple silicon and Intel Macs. Requires macOS 26 (Tahoe) or later.",
      ...
      ctaNote: "macOS 26+ · Apple silicon & Intel · English and 简体中文",
    ...
    'zh-Hans': {
      ...
      installCompatibility: "同一个下载包支持 Apple silicon 和 Intel Mac，需要 macOS 26 (Tahoe) 或更高版本。",
      step1: "下载、解压，拖进“应用程序”。",
      step2: "放行一次。",
      step3: "打开它。",
      ...
      ctaNote: "macOS 26+ · Apple silicon 与 Intel · 英文和简体中文",
      footerLinks: "项目链接",
      footerSource: "源码",
      footerReleases: "发布版本",
