(function () {
  ...
  var STRINGS = {
    en: {
      ...
      heroNote: "Free · Open source · Native Swift · Under 5 MB",
      ...
      fact6Title: "Free, open source, native Swift", fact6Body: "Apache 2.0, zero third-party code, under 5 MB.",
    ...
    'zh-Hans': {
      ...
      ogDescription: "一款不到 5 MB 的开源 macOS 菜单栏应用，让系统航拍壁纸和本地图片按时间、日出与日落自动切换。日出日落在你的 Mac 上本地计算。",
      ...
      heroBody: "一款不到 5 MB 的开源 macOS 菜单栏应用，让系统航拍壁纸和本地图片按时间、日出与日落自动切换。",
      heroDownload: "下载 macOS 26 版",
      heroNote: "免费 · 开源 · 原生 Swift · 不到 5 MB",
      slotsLabel: "今日日程",
      ...
      fact6Title: "免费、开源、原生 Swift", fact6Body: "Apache 2.0，没有任何第三方代码，不到 5 MB。",
